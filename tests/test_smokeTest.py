...
class TestSmokeTest():
  ...
  def test_adminPageTest(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("Admin12345")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("Admin12345")
  ...
  def test_homePageTest(self):
    ...
    self.vars["pageRoute"] = self.driver.execute_script("return window.location.pathname")
    assert(self.vars["pageRoute"] == "/teton/1.6/join.html")
  ...
  def test_joinPageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Zachary")
    self.driver.find_element(By.NAME, "lname").send_keys("Humphreys")
